<script lang="ts" module>
   ...
   import type { Schema } from './example/schema';
   import {
      useSensors,
      MouseSensor,
      TouchSensor,
...
{#if browser}
   <div class="flex flex-col gap-4">
            ...
            <DropdownMenu.Trigger>
               {#snippet child({ props })}
                  <Button variant="outline" size="sm" {...props}>
                     <Icon
                        icon="gravity-ui:layout-header-columns"
                        width="24"
                        height="24"
                        style="color: #0CB3B5"
                     />
      ...
      <div class="overflow-hidden rounded-lg border">
         ...
         >
            <Table.Root>
               <Table.Header class="bg-muted sticky top-0 z-10 rounded-2xl">
      ...
      <div class="flex w-full items-center gap-8 lg:w-fit">
         ...
         <div class="ml-auto flex items-center gap-2 lg:ml-0">
            ...
            <Button
               ...
               disabled={!table.getCanPreviousPage()}
            >
               <span class="sr-only">Go to previous page</span><Icon
                  icon="ic:round-chevron-left"
                  width="24"
                  height="24"
                  style="color: #0CB3B5"
...
{:else}
   <div class="flex flex-col gap-4">
      ...
      <div class="flex w-full flex-col gap-2">
         {#each Array.from({ length: 10 }) as row}
            <Skeleton class="h-7" />
         {/each}
      </div>
   </div>
...
{#snippet DragHandle({ id }: { id: number })}
   ...
   >
      <Icon icon="bx:grid-vertical" class="text-muted-foreground size-3" />
